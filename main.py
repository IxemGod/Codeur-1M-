...
"""
--------------- Codeur 1M+ ---------------
Ce programme est le fruit de 4 ans de 
développement. Ce code crypt et décrypt vos
message avec une clée généré aléatoirement,
dissimuler dans la phrase. Je serais ravis
que vous me prouvier qu'avec un programme,
vous puissiez casser cet algo sans regarder
dans le code ^^

"Une aide sera toujours apportée à ceux qui l'à mérite"
